...
<div class="wrapper" id="index-wrapper">
	...
	<div class="modal fade bd-example-modal-lg" id="highlightsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
					<div class="row">
						...
						<div class="col-lg-9 text-center">
							<div class="card player m-3">
								...
								<div class="card-player-info">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-5">
								...
								<div class="card-player-photo invisible">
								...
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-5">
											...
											<div class="social-media-player mx-2 mt-5">
												<a href="https://www.facebook.com/rutecostaofficial" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
												<a href="https://www.instagram.com/rute_.costa" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
								...
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-5">
											...
											<div class="social-media-player mx-2 mt-5">
												<a href="https://www.facebook.com/AgataaFilipaa" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
												<a href="https://www.instagram.com/agatafilipa16" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
											</div>										
									...
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-5">
											...
											<div class="social-media-player mx-2 mt-5">
												...
												<a href="https://www.instagram.com/aliciafcorreia" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
												<a href="https://twitter.com/AliciaCorreia6" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
											</div>
								...
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-5">
											...
											<div class="social-media-player mx-2 mt-5">
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
												<a href="https://www.instagram.com/brun6l" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
												<a href="https://twitter.com/brun6l" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
											</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/brunaramos_26" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
								...
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-4">
											...
											<div class="social-media-player mx-2 mt-5">
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
												<a href="https://instagram.com/car.pimenta_3" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
											</div>										
								...
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="player-card-info-footer mt-4">
											...
											<div class="social-media-player mx-2 mt-5">
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
												<a href="https://www.instagram.com/marianapintorosa" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
												<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
												<a href="https://twitter.com/mariana_rosa7" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
											</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<a href="https://www.facebook.com/MonicaM24" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
											<a href="https://www.instagram.com/monica_mendes2" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/sofiasilva1878" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/b.lopes915" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<a href="https://twitter.com/BarbaraLopes915" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<a href="https://www.facebook.com/13fatimapinto" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
											<a href="https://www.instagram.com/fatimapinto13" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<a href="https://twitter.com/13fatimapinto" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/joaninhamr" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<a href="https://twitter.com/joaninhamr11" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/margarida50" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/vera_cid11" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<a href="https://twitter.com/veraaaa_cid11" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<a href="https://www.facebook.com/FranciscaCardoso13" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
											<a href="https://www.instagram.com/chicardoso" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											...
											<a href="https://twitter.com/Chicaardoso" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo"></a>
										</div>											
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo">
											<a href="https://www.instagram.com/jaleca_oficial" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<a href="https://www.facebook.com/lydia.andrade.9" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
											<a href="https://www.instagram.com/lydiaandrade23" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/instagram-gold.png" alt="insta-logo"></a>
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo">
											<img class="low-opacity-fixed" src="<?php echo get_template_directory_uri(); ?>/img/twitter-gold.png" alt="twitter-logo">
										</div>										
							...
							<div class="card player m-3">
								<div class="card-player-info invisible">
									<div class="card-body player-card-info">
										...
										<div class="social-media-player mx-2 mt-5">
											<a href="https://www.facebook.com/marianammvc" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/facebook-gold.png" alt="face-logo"></a>
											...
											<a href="https://www.linkedin.com/in/marianamcabral" targer="_blank"><img class="low-opacity" src="<?php echo get_template_directory_uri(); ?>/img/linkedin-gold.png" alt="linkedin-logo"></a>
							...
							<div class="card player placeholder m-3">
								<div class="card-player-photo">
